...
public class Cataloge implements Serializable{
    ...
    public static HashMap<Product,Boolean> readyMadeCatalog(){
        ...
        log.put(new Apple(1.0,200.0),true);
        log.put(new Banana(12.0,120.0),true);
        log.put(new Beef(1.0,600.0),true);
        log.put(new Biscuits(24.0,240.0),true);
        log.put(new Cheese(1.0,1200.00),true);
        log.put(new Chicken(1.0,400.0),true);
        log.put(new Chocolates(1.0,250.0),true);
        log.put(new Eggs(12.0,360.0),true);
        log.put(new Fish(1.0,500.0),true);
        log.put(new Mango(1.0,200.0),true);
        log.put(new Milk(1.0,180.0),true);
        log.put(new Mutton(1.0,1400.0),true);
        log.put(new Rice(1.0,220.0),true);
        log.put(new Shampoo(1.0,450.0),true);
        log.put(new Soap(1.0,110.0),true);
        log.put(new Wheat(1.0,960.0),true);
        log.put(new Yogurt(1.0,210.0),true);
